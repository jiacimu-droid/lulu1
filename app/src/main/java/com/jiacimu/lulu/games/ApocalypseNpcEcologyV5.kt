...
internal fun apocalypseNpcEcologyPromptV5(
    ...
    appendLine("事件生态：末世前的有趣事件可以来自邻里、物业、维修、医疗、交通、购物、送货、学校/工作、宠物和野生动物、天气、轻微治安、误会、人情、临时机会、价格与库存、公共服务、家庭和社交，不必都跟核心谜团有关。")
    appendLine("灾后事件也不能只剩怪物和组织任务：救援与失踪、抢修供水/供电/车辆、交易与黑市、伤员与药品、临时结盟、据点规则、社区争执、路线争夺、动物/植物异变、污染与天气、难民流动、第三方先行动、骗子和投机者、普通人的善意与自私都可以形成完整事件。")
    appendLine("至少保持相当一部分事件与核心谜团完全无关。生活支线允许只带来认识一个人、获得一点情报、欠下一份人情、损失一点时间、发现一个地点或单纯经历一件值得记住的事；不要求每件事都升级成任务链。")
